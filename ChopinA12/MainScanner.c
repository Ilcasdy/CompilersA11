...
/* External objects */
extern chopin_intg line; /* Source code line numbers - defined in scanner.c */
 ...
 * -------------------------------------------------------------
 */
chopin_void printScannerError(chopin_string fmt, ...);
chopin_void displayScanner(BufferPointer ptrBuffer);
chopin_long getScannerFilesize(chopin_string fname);
